        ...
        if($rsnum > 0 ){ //有主分類
            ...
            while($row = $db->fetch_array($selectrs,1)){
                ...
                if($rsnum1 > 0 ){ //有次分類
                    ...
                    $tpl->assign("TAG_SUB_UL1","<ul class=\"sub_menu\">
									<img src=\"".$cms_cfg['base_images']."radiusbg01.png\" class=\"sub_menu_ltbg\" />
									<img src=\"".$cms_cfg['base_images']."radiusbg02.png\" class=\"sub_menu_lbbg\" />
									<img src=\"".$cms_cfg['base_images']."radiusbg03.png\" class=\"sub_menu_rtbg\" />
									<img src=\"".$cms_cfg['base_images']."radiusbg04.png\" class=\"sub_menu_rbbg\" />
									<img src=\"".$cms_cfg['base_images']."radiusbg.jpg\" class=\"sub_menu_bg\" />
									<li class=\"p\">&nbsp;</li>");
                    $tpl->assign("TAG_SUB_UL2","<li class=\"p\">&nbsp;</li></ul>");
